...
?>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb ftco-volunteer">
    	<div class="container-fluid px-md-0">
    		<div class="row no-gutters">
    			<div class="col-md-6 img-volunteer" style="background-image: url(Image/dnld.jpg);">
    				<div class="row no-gutters justify-content-end">
    					<div class="col-lg-7">
    						<div class="text py-5 pl-md-4 pr-md-3">
    							<h2 class="mb-4">History</h2>
    							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics</p>
    							<p><a href="#" class="btn btn-primary py-3 px-4">Read now</a></p>
    						</div>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-6 d-flex align-items-center bg-primary">
    				<div class="about-text px-3 py-5 pl-md-5 pr-md-5">
    					<h2>Visitor so far <br><span>$</span><strong class="number" data-number="380000">0</strong></h2>
    					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics</p>
    					<p><a href="#" class="btn btn-black py-3 px-4">Make a Count  now</a></p>
    				</div>
    			</div>
    		</div>
    	</div>
        ...
        <div class="row no-gutters d-flex">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 text-center services active d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Gallery</h3>
    ...
    <section class="ftco-counter ftco-section img" id="section-counter" style="background-image: url(Image/do.jpg);">
    	<div class="overlay"></div>
    	<div class="container">
    ...
    <section class="ftco-section">
        ...
        <div class="row">
        	<div class="col-md-6">
              ...
              <a href="blog-single.html" class="block-20 img" style="background-image: url('Image/do8.jpg');">
              </a>
        	...
        	<div class="col-md-6">
              ...
              <a href="blog-single.html" class="block-20 thumb" style="background-image: url('Image/image_2.jpg');">
              </a>
            ...
            <div class="blog-entry align-self-stretch d-md-flex bg-light p-3 align-items-center d-flex ftco-animate">
              <a href="blog-single.html" class="block-20 thumb" style="background-image: url('Image/image_3.jpg');">
              </a>
              <div class="text text-thumb d-block pl-2 pl-md-4">
            ...
            <div class="blog-entry align-self-stretch d-md-flex bg-light p-3 align-items-center d-flex ftco-animate">
              <a href="blog-single.html" class="block-20 thumb" style="background-image: url('Image/image_4.jpg');">
              </a>
              <div class="text text-thumb d-block pl-2 pl-md-4">
